...
## Назначение файлов
- `src/main.cpp` — точка входа, меню и маршрутизация действий.
...
- `src/messages.cpp` — таблицы сообщений/строк UI и выбор локали.
...
- `include/messages.h` — структура строк UI и функции доступа к ним/локали.
- `include/validation.h` — интерфейс валидации даты/времени и статусов.
